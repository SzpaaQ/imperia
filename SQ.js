...
var SQ_addButtons 		= function(){if($('.btnnn').length) return;
	SQ_addBtn('<div class="ui-bg ui-buttons"><img src="https://maxcdn.icons8.com/Share/icon/Military//sword1600.png" style="margin-left:7px;width:27px; height:27px;"></div>','SQ_autoattack', 'SQ_startattack');
}
SQ_commitBtns();
