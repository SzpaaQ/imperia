...
var spy 				= function(lvl){if($('#widget-missions').find('.mission-my').length) return;if(!lvl) lvl = 7;
	xajax_doMassSpy(container.open({saveName:'mass-spy-report-100'+lvl, title:'Masowe szpiegostwo: Niezależne miasto'}),{'uId':1000+lvl,'isUserHolding':'1', 'page': 1});
	clearInterval(SQ_otherInterval);SQ_otherInterval=setInterval(function(){SQ_chooseVictim()},1000)}
...
var SQ_chooseVictim 	= function(){if(!$('.spy-mass-report-content').length)
...
var SQ_closeAll 		= function(){clearInterval(SQ_otherInterval);
